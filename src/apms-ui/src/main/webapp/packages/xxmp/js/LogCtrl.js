...
angular.module('WebApp').controller('LogCtrl', ['$rootScope', '$scope', "$listService", "$ajaxCall", function($rootScope, $scope, $listService, $ajaxCall) {
    ...
    $listService.initJsonData($scope, {
        "url": "packages/xxmp/data/log.json",
